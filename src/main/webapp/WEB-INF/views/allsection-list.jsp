                                        ...
                                        <td class="td2">
                                            ...
                                            <span>
                                                    <c:if test="${requestScope.pagemsg.currPage != 1}">
                                                        <a href="/manager/allsection-list?currentPage=1">[首页]</a>&nbsp;&nbsp;
                                                        <a href="/manager/allsection-list?currentPage=${requestScope.pagemsg.currPage-1}">[上一页]</a>&nbsp;&nbsp;
                                                    </c:if>

                                                       <c:if test="${requestScope.pagemsg.currPage != requestScope.pagemsg.totalPage}">
                                                           <a href="/manager/allsection-list?currentPage=${requestScope.pagemsg.currPage+1}">[下一页]</a>&nbsp;&nbsp;
                                                           <a href="/manager/allsection-list?currentPage=${requestScope.pagemsg.totalPage}">[尾页]</a>&nbsp;&nbsp;
                                                       </c:if>
   </span>
                                        </td>
                                    </tr>
