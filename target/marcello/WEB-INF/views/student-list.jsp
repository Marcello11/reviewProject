                                        ...
                                        <td>
                                            <div class="tpl-table-black-operation">
                                                <a href="javascript:;">
                                                    ...
                                                    <input type="button" name="action" value="通过" onclick="addData('${u.stdNum}')">
                                                </a>
                                                <a href="javascript:;" class="tpl-table-black-operation-del">
                                                    <i class="am-icon-trash"></i>
                                                    <input  type="button" name="action" class="delete" value="删除" onclick="deleteData(${u.stdNum})">
                                                </a>
                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td class="td2">
                                            ...
                                            <span>
                                                    <c:if test="${requestScope.pagemsg.currPage != 1}">
                                                        <a href="/user/student-list?currentPage=1">[首页]</a>&nbsp;&nbsp;
                                                        <a href="/user/student-list?currentPage=${requestScope.pagemsg.currPage-1}">[上一页]</a>&nbsp;&nbsp;
                                                    </c:if>

                                                       <c:if test="${requestScope.pagemsg.currPage != requestScope.pagemsg.totalPage}">
                                                           <a href="/user/student-list?currentPage=${requestScope.pagemsg.currPage+1}">[下一页]</a>&nbsp;&nbsp;
                                                           <a href="/user/student-list?currentPage=${requestScope.pagemsg.totalPage}">[尾页]</a>&nbsp;&nbsp;
                                                       </c:if>
   </span>
                                        </td>
                                    </tr>
