                    ...
                    <div class="widget am-cf">
                        ...
                        <div class="am-u-sm-12">
                            <table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black " id="example-r">
                                ...
                                <tbody>
                                <c:forEach items="${requestScope.page.lists}" var="u" >
                                    <tr class="gradeX">
                                        <td>${u.bssName}</td>
                                        <td>${u.bssTel}</td>
                                        <td>
                                ...
                                <table  border="0" cellspacing="0" cellpadding="0"  width="900px">
                                    <tr>
                                        <td class="td2">
                                            ...
                                            <span>总记录数：${requestScope.page.totalCount }&nbsp;&nbsp;每页显示:${requestScope.page.pageSize}</span>&nbsp;&nbsp;
                                            <span>
                                                    <c:if test="${requestScope.page.currPage != 1}">
                                                        <a href="/business/allbusiness-list?currPage=1">[首页]</a>&nbsp;&nbsp;
                                                        <a href="/business/allbusiness-list?currPage=${requestScope.page.currPage-1}">[上一页]</a>&nbsp;&nbsp;
                                                    </c:if>

                                                       <c:if test="${requestScope.occasionPage.currPage != requestScope.occasionPage.totalPage}">
                                                           <a href="/business/allbusiness-list?currPage=${requestScope.page.currPage+1}">[下一页]</a>&nbsp;&nbsp;
                                                           <a href="/business/allbusiness-list?currPage=${requestScope.page.totalPage}">[尾页]</a>&nbsp;&nbsp;
                                                       </c:if>
   </span>
                                        </td>
                                    </tr>
